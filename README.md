...
<!-- Refer explcitly to the files instead of 'Notebook 1, Data exploration, just say `1_data_exploration.ipynb` -->
...
Source: [Kaggle — Corporate Credit Rating with Financial Ratios](link to dataset)
